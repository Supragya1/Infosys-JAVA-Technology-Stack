 ...
 * Though the object of DigitalCamera class is being created with values as 'Canon' and 100 in the main method of Tester class, 
 * the code given below generates the following output.
 * Nikon 0.0 16
 * Make the necessary changes in the code such that the member variables are initialized with proper 
 * values and the output is generated as follows:
 * Canon 100.0 16
 */
class Camera {
